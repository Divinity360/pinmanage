"""
Django settings for djangopinmgmt project.
...
ALLOWED_HOSTS = ['cloudhotel.herokuapp.com','127.0.0.1']
...
ROOT_URLCONF = 'djangopinmgmt.urls'
...
WSGI_APPLICATION = 'djangopinmgmt.wsgi.application'
